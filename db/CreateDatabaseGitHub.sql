...
CREATE TABLE IF NOT EXISTS git_users (id INTEGER PRIMARY KEY AUTO_INCREMENT, username VARCHAR(20), userpassword VARCHAR(20), usertype VARCHAR(2), active BOOLEAN);
