...
CREATE TABLE IF NOT EXISTS git_users (id INTEGER PRIMARY KEY AUTO_INCREMENT, username VARCHAR(20), userpassword VARCHAR(20), firstname VARCHAR(30), secondname(50), usertype VARCHAR(2), active BOOLEAN);
